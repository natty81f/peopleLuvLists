...
PostsListController = RouteController.extend({
  ...
  data: function() {
    ...
    //Tells the postsList route to build its own path using that JavaScript object as data context.
    //this is exactly the same thing as using the {{pathFor 'postsList'}} Spacebars helper, except we're replacing the implicit this by our own custom-made data context.
